...
test_that("mixed: Maxell & Delaney (2004), Table 16.6, p. 845", {
  ...
  expect_that(round(sqrt(diag(vcov(mixed2_orig$full_model))), 3), equals(c(3.229, 4.548)))
...
test_that("mixed: Maxell & Delaney (2004), Table 16.7, p. 851 (uses simple F!)", {
  ...
  expect_that(round(sqrt(diag(vcov(mixed3_orig$full_model))), 2), equals(c(5.82, 2.72, 0.81)))
