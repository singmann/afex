...
test_that("glmmTMB object", {
  ...
  expect_equivalent(tmb, tmb2)
  
  skip_if_not_installed("cowplot")
  skip_if_not_installed("gplot2")
  library("ggplot2")
...
test_that("rstanarm plots", {
  ...
  expect_equivalent(b1, b1n)
  expect_equivalent(b2, b2n)
  expect_equivalent(b3, b3n)
  expect_equivalent(b4, b4n)
})
...
test_that("rstanarm plots", {
  ...
  expect_equivalent(bb1, bb1n)
  expect_equivalent(bb2, bb2n)
})
