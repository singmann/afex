...
#'   \item{\code{recover_data} and \code{emm_basis}}{Provide the backbone for using \code{\link{emmeans}} and related functions from \pkg{emmeans} directly on \code{afex_aov} objects by returning a \code{\link{emmGrid}} object. Should not be called directly but through the functionality provided by \pkg{emmeans}.}
#'   
#' }
#'
#' @details 
