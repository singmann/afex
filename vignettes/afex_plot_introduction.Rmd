...
In case we have overlapping lines and error bars or use large lines, we sometimes do not want that the error bars also receives different line types. To disable this behavior and always show error bars as solid lines, set `error_linetype = FALSE`. This is shown in the left plot.
