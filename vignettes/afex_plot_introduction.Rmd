...
Note that we could have also used the `factor_levels` argument to change the order of the factor levels by passing a named character vector (e.g., `factor_levels = list(angle = c(X8 = "8°", X4 = "4°", X0 = "0°"))`). This would change the order either in the legend or on the x-axis.
